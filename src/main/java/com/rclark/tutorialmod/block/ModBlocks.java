package com.rclark.tutorialmod.block;

import com.rclark.tutorialmod.TutorialMod;
import com.rclark.tutorialmod.block.custom.ModFlammableRotatedPillarBlock;
import com.rclark.tutorialmod.item.ModItems;
import com.rclark.tutorialmod.worldgen.tree.EbonyTreeGrower;
...
public class ModBlocks {
    ...
    // until we can figure out how to register blocks again, we are going to use .copy(Blocks.whatever) instead of .of(Material.whatever) (it was previously stone)
    ...
    public static final RegistryObject<Block> BLACK_OPAL_ORE = registerBlock("black_opal_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE) // middle mouse to zoom in!
